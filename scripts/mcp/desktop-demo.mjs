...
const desktop = spawn(process.env.DISPLAY ? binary : 'xvfb-run', process.env.DISPLAY ? [] : ['-a', binary],
...
try {
  ...
  for (const script of ['security.mjs', 'acceptance.mjs', 'design-engines.mjs']) {
